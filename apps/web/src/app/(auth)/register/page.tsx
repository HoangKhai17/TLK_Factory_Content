    ...
    <div className="w-full max-w-[420px]">
      <div className="bg-white rounded-3xl shadow-[0_4px_32px_rgba(59,130,246,0.10)] border border-[#E2E8F0] overflow-hidden">
        ...
        <div className="px-8 pt-8 pb-10">
          ...
          <h1 className="text-[22px] font-bold text-[#0F172A] mb-1">Tạo tài khoản</h1>
          <p className="text-[13.5px] text-[#64748B] mb-7">Bắt đầu tạo video tự động với AI</p>
          ...
          <p className="text-center text-[12.5px] text-[#94A3B8] mt-6">
            Đã có tài khoản?{" "}
            <Link href="/login" className="text-[#3B82F6] font-semibold hover:text-[#2563EB]">
              Đăng nhập
            </Link>
          </p>
        </div>
